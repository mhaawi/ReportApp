...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            cm.createCache(io.github.jhipster.application.domain.Report.class.getName() + ".params", jcacheConfiguration);
            cm.createCache(io.github.jhipster.application.domain.Param.class.getName(), jcacheConfiguration);
